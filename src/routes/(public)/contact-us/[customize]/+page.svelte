<script lang="ts">
	...
	let customizeString =
		"I'm interested in purchasing the hat " +
		$page.params.customize +
		' but would like to add a custom touch to it.';
...
<p class="message">
	Thank you for your interest in this Crazy P lid. We'd be happy to customize this hat for you!
</p>
